...
This assignment was done using Eclipse.  Eclipse is required to run the application
...
3) Give it a project name: JAC444B-A2-T6 (courseCode_section-Assignment#-TeamNumber)
